...
import com.zly.commons.db.CharBooleanTypeHandler;
import com.zly.commons.db.DataScriptInitializer;
import com.zly.commons.db.JsonStringTypeHandler;
...
import static com.zly.commons.db.identifier.SnowflakeSequence.MAX_DATACENTER_ID;
import static com.zly.commons.db.identifier.SnowflakeSequence.MAX_WORKER_ID;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.zly.cms.core.mapper", "com.zly.cms.ext.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
