package com.zly.cms.core.aop;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.zly.cms.core.domain.OperationLog;
import com.zly.cms.core.domain.User;
import com.zly.cms.core.service.OperationLogService;
...
public class OperationLogAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.zly.cms.core.aop.annotations.OperationLog)")
    ...
    private OperationLog operationLog(JoinPoint joinPoint) throws JsonProcessingException {
        ...
        com.zly.cms.core.aop.annotations.OperationLog annotation =
                method.getAnnotation(com.zly.cms.core.aop.annotations.OperationLog.class);
