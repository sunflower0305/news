...
@Mapper
@Repository
public interface OrgArticleMapper {
    /**
     * 插入数据
     *
     * @param bean 实体对象
     ...
     */
    @Nullable
    OrgArticle select(@Param("orgId") Long orgId, @Param("channelId") Long channelId);
