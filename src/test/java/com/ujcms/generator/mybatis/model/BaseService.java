...
public class BaseService extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        topLevelClass.addImportedType("com.query.commons.zly.QueryInfo");
        topLevelClass.addImportedType("com.query.commons.zly.QueryParser");
        // topLevelClass.addImportedType("com.service.core.cms.zly.SeqService");
        topLevelClass.addImportedType("com.identifier.db.commons.zly.SnowflakeSequence");
        topLevelClass.addImportedType("org.springframework.stereotype.Service");
        // @Service 注解
        ...
        // moveOrder 方法
        if ("true".equalsIgnoreCase(introspectedTable.getTableConfigurationProperty("order"))) {
            topLevelClass.addImportedType("com.order.db.commons.zly.OrderEntityUtils");
